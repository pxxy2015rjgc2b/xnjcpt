				...
				<div class="show_content">
					...
					<div class="operation_button">
						...
						<div class="search_cloud">
							<input class="search_input" type="text" placeholder="请填写搜索内容" />
						...
						<div class="page-footer">
							<div class="page_info" style="text-align: center;">
								...
								<a onclick="lastPage()">尾页<i
									...
									type="text" style="width: 50px;" id="goInput" />&nbsp;&nbsp;&nbsp;&nbsp;
								<a onclick="goPage()">GO</a>
							</div>
							<div
								style="width: 100px; height: 70px; margin: 0px auto; text-align: center;">
