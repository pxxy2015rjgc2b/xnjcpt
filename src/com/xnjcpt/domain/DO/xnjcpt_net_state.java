...
public class xnjcpt_net_state {
	private String net_state_id;//����״̬������	
	private String disk_state_computer;	//����������	
	private String disk_state_time;//ʱ��	
	private String net_state_obandwidth;	//������		
	private String net_state_ibandwidth;	//�����		
	private String net_state_opackage;//������	
	private String net_state_ipackage;//�����	
	private String net_state_tcp_number;//tcp���Ӹ���
	private String net_state_otraffic;//������	
	private String net_state_gmt_create;//�ֶδ���ʱ��
	private String net_state_gmt_modified;//�ֶ��޸�ʱ��
