...
public class ComputerAction {
	...
	public void getUser_computerById()
	{computerService.getUser_computerById(user_computer_id);}
	
	
	//分页显示数据
	public void getUserComputerByPage() {
		computerService.getUserComputerByPage(queryString, currPage);	
}
	public void getComputerByPage() {
		computerService.getComputerByPage(queryString, currPage);	
}
}