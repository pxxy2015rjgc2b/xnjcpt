...
public class SendEmail {
	...
	public static String sendEmail(String receiveMailAccount, String username, String verifyCode) throws Exception {
		...
		// String verifyCode = String.valueOf(new Random().nextInt(899999) +
		// 100000);// 生成短信验证码
		...
		// message.setContent(username + "用户你好,您的提供操作的验证码是" + verifyCode,
		// "text/html;charset=UTF-8");
		message.setContent(username + "<H1>用户你好,云栖系统激活邮件！点击以下链接进行账户激活</H1> <h3><a href='" + path
				+ "user/user_activate?user.user_id=" + verifyCode + "'>" + path + "user/user_activate?user.user_id="
				+ verifyCode + "</a></h3>", "text/html;charset=UTF-8");
		// 8. 设置发件时间
